  ...
  <section class="profile">
    ...
    <template v-else>
      <section class="profile__grid">
        ...
        <article class="card profile__panel">
          <h3 class="profile__panel-title">Default settings</h3>
        ...
        <article class="card profile__panel">
          <h3 class="profile__panel-title">Approvals and workflow</h3>
          <label class="profile__field">
        ...
        <article class="card profile__panel">
          <h3 class="profile__panel-title">Security</h3>
          <label class="profile__field">
          ...
          <div class="profile__actions">
            ...
            >
              {{ passwordLoading ? "Submitting..." : "Change password" }}
            </button>
            <button
              type="button"
        ...
        <article v-if="isAdmin" class="card profile__panel">
          <h3 class="profile__panel-title">Organization preferences</h3>
